...
public class SavedByCategory extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.saved_by_category);
        scrollView = findViewById(R.id.scrollview_category);
        linearLayout = findViewById(R.id.line_layout_category);
        back = findViewById(R.id.back_savedbycategory);
        auth = FirebaseAuth.getInstance();
        category = findViewById(R.id.textView_category);
        database = FirebaseDatabase.getInstance();
        ref = database.getReference("Users");
        sp = getSharedPreferences("categoryPref", MODE_PRIVATE);
        category.setText("Category - "+sp.getString("category", ""));
